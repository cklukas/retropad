...
OBJS=$(OUTDIR)\retropad.obj $(OUTDIR)\file_io.obj $(OUTDIR)\print.obj $(OUTDIR)\retropad.res
...
$(OUTDIR)\retropad.exe: $(OBJS)
	$(CC) $(CFLAGS) $(LDFLAGS) $(OUTDIR)\retropad.obj $(OUTDIR)\file_io.obj $(OUTDIR)\print.obj $(OUTDIR)\retropad.res $(LIBS) /Fe:$(OUTDIR)\retropad.exe
...
clean:
	-del /q $(OUTDIR)\retropad.exe $(OUTDIR)\retropad.obj $(OUTDIR)\file_io.obj $(OUTDIR)\print.obj $(OUTDIR)\retropad.res $(OUTDIR)\*.pdb 2> NUL
	-del /q retropad.exe retropad.obj file_io.obj print.obj retropad.res retropad.pdb 2> NUL
